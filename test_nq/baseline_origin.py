...
generator_tokenizer = AutoTokenizer.from_pretrained("google/flan-t5-base", device_map="auto")
generator_model = AutoModelForSeq2SeqLM.from_pretrained("google/flan-t5-base", device_map="auto")
